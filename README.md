...
<head>
  ...
  <title>Shri Sai Seva Charitable Sanstha, Bhiwandi</title>
  <style>
    /* * Enhanced CSS for better aesthetics, readability, and responsiveness.
     * Uses colors inspired by the Sanstha's theme (Yellow/Saffron and Deep Red/Brown).
     */
    body {
      font-family: 'Inter', sans-serif; 
      background-color: #fff8e1; /* Very light yellow/cream */
      color: #5e2129; /* Deep reddish brown */
      text-align: center;
      padding: 0;
      margin: 0;
      line-height: 1.6;
    ...
    header {
      background-color: #fbc02d; /* Sai Baba Yellow */
      padding: 20px 10px;
    ...
    h2, h3 {
      color: #c62828; /* Deep red for section titles */
      margin-top: 0;
      margin-bottom: 15px;
    }
...
<body>
  ...
  <main>
    ...
    <h2>Welcome Devotees to the Sai Mandir Website</h2>
